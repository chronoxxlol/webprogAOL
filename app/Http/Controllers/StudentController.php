...
class StudentController extends Controller
{
    ...
    {
        // Retrieve all students associated with the authenticated user
    ...
    {
        // Authorize the user to edit this specific student
    ...
    {
        // Authorize the user to update this specific student
        $this->authorize('update', $student);
